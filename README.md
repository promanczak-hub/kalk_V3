...
> 7. Zero Skrótów i Pełna Implementacja (DoD): Masz całkowity zakaz ucinania kodu, stosowania komentarzy typu `// TODO: implement logic tu` czy zostawiania placeholderów w odpowiedziach. Musisz dostarczać pełne, skończone bloki kodu. Zanim zakomunikujesz, że zadanie jest gotowe, musi przejść przez lintery, typowanie i upewnij się, że opisałeś jakie komponenty w systemie zmieniłeś. Koniec z traktowaniem bazy i aplikacji jako "czarnej skrzynki".
