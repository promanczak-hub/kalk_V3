...
class VehicleDataDTO(BaseModel):
    model_config = {"extra": "allow"}  # Temporarily allow extra fields for seamless migration
    ...
    zabudowa_type_id: Optional[int] = Field(None, description="Identyfikator rodzaju zabudowy")
    zabudowa_apr_wr: Optional[bool] = Field(None, description="Czy zabudowa ma znaczenie w procesie RV")
    ...
    body_type_name: Optional[str] = Field(None, description="Nazwa nadwozia bezpośrednio z wyciągu")
