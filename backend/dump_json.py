...
if o.data: 
    ...
    if stan:
        fields = ["monthly_price_net", "price_net", "base_price_net", "wibor_pct", "margin_pct", "pricing_margin_pct", "discount_pct", "z_oponami", "replacement_car_enabled", "calc_matrix_trace", "discount", "_extraction_metadata", "toggles"]
        for f in fields:
