    ...
    for vid in vehicles:
        ...
        for cell in matrix:
            if cell.get("Okres") == 48 and cell.get("Przebieg") == 15000:
                print(f"LIVE (0% margin): {cell.get('LacznaStawka')}")
                
        # print config base price
        print(f"Base price net in calc_input: {base_input.base_price_net}")
