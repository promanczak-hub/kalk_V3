...
def test():
    ...
    valid_utility = [
      {
        "name": "DMC zespołu pojazdów",
        "value": "6 000 kg"
      },
      {
        "name": "Dopuszczalna masa - oś przednia",
        "value": "1 800 kg"
      },
      {
        "name": "Dopuszczalna masa całkowita (DMC)",
        "value": "3 500 kg"
      },
      {
        "name": "Masa własna bez kierowcy",
        "value": "2234 kg"
      },
      {
