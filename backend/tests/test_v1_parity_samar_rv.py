...
def test_skoda_octavia_rs_v1_parity():
    ...
    assert abs(color_correction_brutto - (-1813.0)) < 0.05, "Kara za lakier Niemetalik musi wynosić -1% ceny bazowej katalogowej (-1813 PLN)"
    ...
    assert abs(mileage_correction_brutto - (-2307.76)) < 0.05, "Korekta przebiegu netto z matematycznego koszyka paczek musi opiewać na -2307.76 PLN"
