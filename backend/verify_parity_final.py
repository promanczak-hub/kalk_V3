...
def verify_parity(vehicle_id: str):
    ...
    test_params = [(36, 15000), (48, 20000), (24, 10000)]
    ...
    for dur, mileage in test_params:
        cached_row = next(
            (
                ...
                if r["duration_months"] == dur and r["annual_mileage"] == mileage
            ),
            None,
        )
        if not cached_row:
        ...
        print(
            f"Tile {dur}m / {mileage}km: Cache={cached_price:.2f} | Live={live_price:.2f} | {status}"
        )
