        ...
        {effectivePricesLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-1.5">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-slate-700 font-mono">
                  {[
                    price?.tire_class ?? car.tire_class,
                    price?.service_type ?? car.service_cost_type,
                  ].filter(Boolean).join(' · ') || '—'}
                </div>
              </div>
            </div>
            ...
            {/* Snapshot of the calculation params (rabat / opony / ubezpieczenie /
                ...
                is shown in this card, these need to be visible so the salesperson
                can see at a glance what was assumed when this rate was computed. */}
            <div className="mt-2">
              <KalkulacjaParamsRow
                snapshot={price}
