...
export function TechSpecsSection({ vehicleData, brochureData, onChange }: TechSpecsSectionProps) {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1 col-span-2">
          <label className="text-xs text-slate-500 font-medium">Silnik / Napęd (opis)</label>
          <input
            type="text"
        ...
        <div className="space-y-1">
          <label className="text-xs text-slate-500 font-medium">Skrzynia biegów</label>
          <input
            type="text"
            value={brochureData?.transmission ?? ""}
            onChange={(e) => onChange("transmission", e.target.value)}
            className="w-full text-sm p-2 border border-slate-200 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
            placeholder="np. 8-biegowy automat"
          />
        </div>

        <div className="space-y-1">
          <label className="text-xs text-slate-500 font-medium">Napęd</label>
          <input
            type="text"
            value={brochureData?.drive_type ?? ""}
            onChange={(e) => onChange("drive_type", e.target.value)}
            className="w-full text-sm p-2 border border-slate-200 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
            placeholder="np. quattro 4×4"
          />
        </div>
