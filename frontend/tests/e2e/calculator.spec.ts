...
test.describe('Calculator & Pipeline', () => {
  test('should load Historia Kalkulacji page', async ({ page }) => {
    ...
    // Let's verify the tab "Historia Kalkulacji" is selected
    const tabEl = page.getByRole('tab', { name: 'Historia Kalkulacji' });
