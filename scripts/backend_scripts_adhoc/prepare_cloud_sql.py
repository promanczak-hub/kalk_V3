...
with open(
    "d:/kalk_v3/supabase/migrations/20260308170000_create_reverse_search_schema.sql",
    "r",
    encoding="utf-8",
) as f:
    sql1 = f.read()
...
with open(
    "d:/kalk_v3/supabase/migrations/20260310120000_add_metadata_to_universal_features.sql",
    "r",
    encoding="utf-8",
) as f:
    sql2 = f.read()
