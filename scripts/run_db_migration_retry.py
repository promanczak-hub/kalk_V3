...
def run_migration():
    ...
    hosts = [
        ...
        ("aws-0-eu-central-1.pooler.supabase.com", f"postgres.{project_ref}"),
        ("aws-0-eu-west-1.pooler.supabase.com", f"postgres.{project_ref}"),
        ("aws-0-us-east-1.pooler.supabase.com", f"postgres.{project_ref}"),
    ]
