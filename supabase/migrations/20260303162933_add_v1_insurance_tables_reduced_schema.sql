...
CREATE TABLE IF NOT EXISTS public.v1_admin_ubezpieczenie (
...
CREATE TABLE IF NOT EXISTS public.v1_admin_parametry (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.ubezpieczenie_wspolczynniki_szkodowe (
