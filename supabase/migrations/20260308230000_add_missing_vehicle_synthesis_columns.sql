-- Fix: Add columns that were manually added but never migrated.
-- They were lost after `supabase db reset`.

-- 1. Add missing columns to vehicle_synthesis
...
-- 2. Rebuild fleet_management_view with document_category + vehicle_class
