-- Migration: Fix rpc_reverse_search for dynamic margin GROUP BY error and restore range filters
-- Combines dynamic margin logic with gte/lte range filter logic
