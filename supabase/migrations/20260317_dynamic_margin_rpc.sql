-- Migration: Optimize rpc_reverse_search to use dynamic margin calculation
-- Instead of filtering by margin_pct, compute price dynamically: cost_0% / (1 - margin/100)
...
begin
    ...
    vehicle_matrix_best as (
        ...
        where vmc.margin_pct = 0
          and (ctx.req_duration is null or vmc.duration_months = ctx.req_duration)
