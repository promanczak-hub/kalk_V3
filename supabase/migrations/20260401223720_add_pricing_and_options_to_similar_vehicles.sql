...
CREATE OR REPLACE FUNCTION reverse_search.rpc_get_similar_vehicles_semantic(p_vehicle_id uuid, p_limit integer DEFAULT 5, p_duration_months integer DEFAULT NULL::integer, p_annual_mileage integer DEFAULT NULL::integer)
...
BEGIN
  SELECT semantic_embedding INTO v_embedding 
